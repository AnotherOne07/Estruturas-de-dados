...
typedef struct {
  int valor;
  int chegada; // Para prioridades iguais, o critério para um elemento ser colocado como primeiro será a ordem de chegada
  int prio; // aqui, quanto maior o valor numérico da prioridade, maior ela é
} ITEM;
...
// retorna true se achar o elemento na heap e false se não achar
